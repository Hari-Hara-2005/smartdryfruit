...
const gramOptions = [
    { value: '1bottle', label: '1bottle' },
    { value: '2bottle', label: '2bottle' },
    { value: '3bottle', label: '3bottle' },
    { value: '4bottle', label: '4bottle' },
];
...
const ProductCard = ({ product, isLoading }) => {
    ...
    const [selectedGram, setSelectedGram] = useState('1bottle'); // Default to 1pocket
    ...
    const handleShareClick = async (product) => {
        const shareUrl = `https://smartdryfruitdryfruit.vercel.app/drinks`;
    ...
    return (
        <>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'start', color: 'black', px: [2, 5, 4] }}>
                <Title color="#282828">Drinks</Title>
            </Box>
            ...
            <Box sx={{ textAlign: 'center', px: [2, 3, 0], py: [5], zIndex: 30 }}>
                <Grid container spacing={6} justifyContent="center" alignItems="center">
                    {drinks.map((drink) => (
                        <Grid item key={drink.id} xs={12} sm={6} md={3.8} lg={3.6}>
                            <ProductCard product={drink} isLoading={isLoading} />
                        </Grid>
                    ))}
                </Grid>
            </Box>
