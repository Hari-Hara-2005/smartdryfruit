...
import { powders } from "../../utils/data";
    ...
    return (
        <>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'start', color: 'black', px: [2, 5, 4] }}>
                <Title color="#282828">Powders</Title>
            </Box>
            ...
            <Box sx={{ textAlign: 'center', px: [2, 3, 0], py: [5], zIndex: 30 }}>
                <Grid container spacing={6} justifyContent="center" alignItems="center">
                    {powders.map((powder) => (
                        <Grid item key={powder.id} xs={12} sm={6} md={3.8} lg={3.6}>
                            <ProductCard product={powder} isLoading={isLoading} />
                        </Grid>
                    ))}
                </Grid>
            </Box>
